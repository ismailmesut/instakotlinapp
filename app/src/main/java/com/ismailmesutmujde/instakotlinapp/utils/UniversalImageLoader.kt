...
class UniversalImageLoader(val mContext : Context) {
    ...
    companion object {
        ...
        fun setImage(imgURL:String, imageView:ImageView, mProgressBar:ProgressBar?, imgURLProtocolName:String?) {
            val imageLoader = ImageLoader.getInstance()
            imageLoader.displayImage(imgURLProtocolName+imgURL, imageView, object : ImageLoadingListener{
